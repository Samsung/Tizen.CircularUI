...
using CCircularListView = global::CircularUI.CircleListView;

[assembly: ExportRenderer(typeof(CircularUI.CircleListView), typeof(CircularUI.Tizen.CircleListViewRenderer))]
...
namespace CircularUI.Tizen
{
    ...
    public class CircleListViewRenderer : ViewRenderer<CCircularListView, CircleListView>
    {
        ...
        {
            RegisterPropertyHandler(global::CircularUI.CircleListView.HasUnevenRowsProperty, UpdateHasUnevenRows);
