...
namespace Tizen.Wearable.CircularUI.Forms.Renderer
{
    public class MediaPlayerImpl : IPlatformMediaPlayer
    {
        ...
        public async Task<bool> Start()
        {
            ...
            {
                Log.Error(Circular.Tag, $"Error On Start : {e.Message}");
                return false;
            }
        ...
        public void Pause()
        {
            ...
            {
                Log.Error(Circular.Tag, $"Error on Pause : {e.Message}");
            }
        }

        public void Stop()
        {
            Log.Debug(Circular.Tag, "Stop");
        ...
        public async Task<int> Seek(int ms)
        {
            ...
            {
                Log.Error(Circular.Tag, $"Fail to seek : {e.Message}");
            }
            return Position;
        }
        ...
        void ApplyDisplay()
        {
            ...
            else
            {
                ...
                if (renderer is IMediaViewProvider provider && provider.GetMediaView() != null)
                {
                    ...
                    {
                        Log.Error(Circular.Tag, "Error on MediaView");
                    }
                }
            }
        }
        ...
        async Task Prepare()
        {
            ...
            {
                Log.Error(Circular.Tag, $"Error on prepare : {e.Message}");
            }
            tcs.SetResult(true);
        }
